...
$sql = "SELECT * FROM employer WHERE Employer_Login_id = '$login_id'";
...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO job (Job_Description, Job_Ref_no, Job_application_end_date, Job_Employer_id) 
                VALUES ('$Job_Description', '$Job_Ref_no', '$Job_application_end_date', '$Employer_id')";
                ...
                <h4><strong>ADD JOB</strong></h4>
                    <div class="content">
                        <div class="input-group">
                            <textarea type="text" class="form-control" placeholder="Job Description" name="Job_Description" required="required"></textarea>
                        ...
                        <br>
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="Reference Number" name="Job_Ref_no" required="required">
                            <span class="input-group-addon">
                                <i class="zmdi zmdi-account-circle"></i>
                            </span>
                        </div>
                    ...
                    <div class="input-group">
                        ...
                        <br>
                            <input type="date" class="form-control" id="dates" placeholder="Application End Date" name="Job_application_end_date" required="required">
                            <span class="input-group-addon">
                                <i class="zmdi zmdi-account-circle"></i>
                            </span>
                        </div>
                    ...
                    <div class="footer">
                        <button class="btn btn-primary btn-round" name="submit">Add Job</button>
                        <button class="btn btn-warning btn-round" name="submit">Cancel</button>
