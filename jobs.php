...
$sql = "SELECT * FROM job WHERE Job_Employer_id = $Employer_id";
                        ...
                        <tbody>
                            <tr>
                                <?php while($row = mysqli_fetch_assoc($rows)):?>
                                    ...
                                    <td><?php echo $row["Job_application_end_date"]?></td>  
                                    <td><button class="btn btn-warning btn-round" onclick="window.location.href='editjob.php?id=<?php echo $row['Job_id']?>'">Edit</button></td>
                                    <td><button class="btn btn-danger btn-round" onclick="window.location.href='deletejob.php?id=<?php echo $row['Job_id']?>'">Delete</button></td>                              
                            </tr>
                            <?php  endwhile; ?>
                        </tbody>
                    </table>
