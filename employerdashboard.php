...
<!-- sidebar part end -->
 ...
 <section class="main_content dashboard_part">
        <!-- menu  -->
    <div class="container-fluid no-gutters" style="color:blue;">
        <div class="row">
    ...
    <?php
    $sql = "SELECT * FROM applicant_documents WHERE Document_verification_status = 'UNVERIFIED'";
    $result = mysqli_query($conn, $sql);
    $unverified = mysqli_num_rows($result);

    $sql = "SELECT * FROM applicant_documents WHERE Document_verification_status = 'VERIFIED'";
    $result = mysqli_query($conn, $sql);
                                ...
                                <div class="col-12">
                                    <div class="quick_activity_wrap">
                                        <div class="single_quick_activity">
                                            <h4>Job Applicant Unverified Documents</h4>
                                            <h3><span class="counter"><?php echo $unverified; ?></span> </h3>
                                        </div>
                                        <div class="single_quick_activity">
                                            <h4> Total Job Applicant Verified Documents</h4>
                                            <h3><span class="counter"><?php echo $verified; ?></span> </h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
