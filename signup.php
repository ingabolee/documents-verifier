...
if(isset($_POST['submit'])){
    ...
    $Applicant_national_id = $_POST['Applicant_national_id'];
    ...
    if($Login_password == $cpassword){
        ...
        if ($result -> num_rows > 0){
            ...
            $sql = "SELECT * FROM job_applicant WHERE Applicant_email = '$Applicant_email'";
            $result = mysqli_query($conn, $sql);
            if ($result -> num_rows > 0){
                ...
                //owner table
                $sql = "INSERT INTO job_applicant (Applicant_name, Applicant_mobile_number, Applicant_email, Applicant_national_id, Applicant_login_id) 
                VALUES ('$Applicant_name', '$Applicant_mobile_number', '$Applicant_email', '$Applicant_national_id', '$login_id')";
                $result = mysqli_query($conn, $sql);
                                ...
                                <div class="modal-content cs_modal">
                                    <div class="modal-header">
                                        <div class="row">
                                            ...
                                            <a href="signupschool.php">
                                                <button class="btn btn-warning">Sign Up as School</button>
                                            </a> 
                                        </div>
                                    </div>
                                    <div class="modal-header">
                                        <h5 class="modal-title">Applicant Registration</h5>
                                    </div>
                                        ...
                                        <form class="form" method="POST" action="#">
                                            ...
                                            <div class="content">                                                
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" placeholder="Name" name="Applicant_name" required="required">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" class="form-control" placeholder="contact" name="Applicant_mobile_number" required="required">
                                                    <span class="input-group-addon">
                                                        <i class="zmdi zmdi-account-circle"></i>
                                                    </span>
                                                </div>
                                                <div class="input-group">
                                                    <input type="email" class="form-control" placeholder="email" name="Applicant_email" required="required">
                                                    <span class="input-group-addon">
                                                        <i class="zmdi zmdi-email"></i>
                                                    </span>
                                                </div>
                                                <div class="input-group">
                                                    <input type="number" class="form-control" placeholder="National ID" name="Applicant_national_id" required="required">
                                                    <span class="input-group-addon">
                                                        <i class="zmdi zmdi-account-circle"></i>
                                                    </span>
                                                </div>
