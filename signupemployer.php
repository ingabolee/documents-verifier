...
if(isset($_POST['submit'])){
    ...
    $Employer_physical_address = $_POST['Employer_physical_address'];
    ...
    if($Login_password == $cpassword){
        ...
        if ($result -> num_rows > 0){
            ...
            if ($result -> num_rows > 0){
                ...
                VALUES ('$Login_user_name', '$Login_password', '3')";
                $result = mysqli_query($conn, $sql);
                ...
                //owner table
                $sql = "INSERT INTO employer (Employer_name, Employer_mobile_number, Employer_email, Employer_physical_address, Employer_login_id) 
                VALUES ('$Employer_name', '$Employer_mobile_number', '$Employer_email', '$Employer_physical_address', '$login_id')";
                $result = mysqli_query($conn, $sql);
                                        ...
                                        <form class="form" method="POST" action="#">
                                            ...
                                            <div class="content">                                                
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" placeholder="Name" name="Employer_name" required="required">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" class="form-control" placeholder="contact" name="Employer_mobile_number" required="required">
                                                    <span class="input-group-addon">
                                                        <i class="zmdi zmdi-account-circle"></i>
                                                    </span>
                                                </div>
                                                <div class="input-group">
                                                    <input type="email" class="form-control" placeholder="email" name="Employer_email" required="required">
                                                    <span class="input-group-addon">
                                                        <i class="zmdi zmdi-email"></i>
                                                    </span>
                                                </div>
                                                <div class="input-group">
                                                    <input type="number" class="form-control" placeholder="Physical Address" name="Employer_physical_address" required="required">
                                                    <span class="input-group-addon">
                                                        <i class="zmdi zmdi-account-circle"></i>
                                                    </span>
                                                </div>
